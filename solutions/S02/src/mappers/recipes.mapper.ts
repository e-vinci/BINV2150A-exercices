import { NewRecipe, NewRecipeDTO, Recipe, RecipeDBO, RecipeDTO, UpdatedRecipeDTO } from "../models/recipe.model";
...
export class RecipesMapper {
  ...
  /**
   * S02 : Fusionne les champs envoyés dans un PATCH avec la recette existante.
   */
  static fromUpdatedDTO(dto: UpdatedRecipeDTO, existing: Recipe): NewRecipe {
    return {
      ...
      prepTime: dto.prepTime !== undefined ? dto.prepTime : existing.prepTime,
      cookTime: dto.cookTime !== undefined ? dto.cookTime : existing.cookTime,
      servings: dto.servings !== undefined ? dto.servings : existing.servings,
      difficulty: dto.difficulty !== undefined ? dto.difficulty : existing.difficulty,
      categoryId: dto.categoryId !== undefined ? dto.categoryId : existing.categoryId,
      tags: dto.tags !== undefined ? dto.tags : existing.tags,
      ingredients: dto.ingredients !== undefined ? dto.ingredients : existing.ingredients,
      steps: dto.steps !== undefined ? dto.steps : existing.steps,

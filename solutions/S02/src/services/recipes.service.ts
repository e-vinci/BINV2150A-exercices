...
export class RecipesService extends AbstractService {
  ...
  // ===========================================================================
  // MODIFICATION SEANCE 02 : Methode patch pour la mise a jour partielle
  // ===========================================================================

  /**
   * Met a jour partiellement une recette.
   * L'id, l'auteur et la date de creation sont strictement preserves.
   * La date de mise a jour (updatedAt) est reactualisee.
   * @returns la recette mise a jour, ou undefined si elle n'existe pas ou en cas d'erreur
   */
